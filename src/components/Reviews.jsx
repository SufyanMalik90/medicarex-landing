...
const Reviews = () => {
      ...
      <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
        <div className="w-full">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-11 pb-11 border-b border-gray-100 max-xl:max-w-2xl max-xl:mx-auto">
            <div className="box flex flex-col gap-y-4 w-full ">
              <div className="flex items-center w-full">
                ...
                <p className="h-2 w-full sm:min-w-[278px] rounded-3xl bg-gray-100 ml-5 mr-3">
                  <span className="h-full w-[30%] rounded-3xl bg-[#1A5091] flex"></span>
                </p>
              ...
              <div className="flex items-center w-full">
                ...
                <p className="h-2 w-full xl:min-w-[278px] rounded-3xl bg-gray-100 ml-5 mr-3">
                  <span className="h-full w-[40%] rounded-3xl bg-[#1A5091] flex"></span>
                </p>
              ...
              <div className="flex items-center">
                ...
                <p className="h-2 w-full xl:min-w-[278px] rounded-3xl bg-gray-100 ml-5 mr-3">
                  <span className="h-full w-[20%] rounded-3xl bg-[#1A5091] flex"></span>
                </p>
              ...
              <div className="flex items-center">
                ...
                <p className="h-2 w-full xl:min-w-[278px] rounded-3xl bg-gray-100 ml-5 mr-3">
                  <span className="h-full w-[16%] rounded-3xl bg-[#1A5091] flex"></span>
                </p>
              ...
              <div className="flex items-center">
                ...
                <p className="h-2 w-full xl:min-w-[278px] rounded-3xl bg-gray-100 ml-5 mr-3">
                  <span className="h-full w-[8%] rounded-3xl bg-[#1A5091] flex"></span>
                </p>
            ...
            <div className="p-8  rounded-3xl flex items-center justify-center flex-col">
              <h2 className="font-manrope font-bold text-5xl text-[#1A5091] mb-6">
                4.3
              </h2>
  ...
  <div className="flex flex-wrap gap-4 justify-center">
    {/* Card 1 */}
    <div className="w-full max-w-sm rounded p-4 bg-white shadow-[0_6px_24px_-12px_rgba(0,0,0,0.2)] border hover:shadow-lg transition-all duration-300 transform hover:scale-105">
      <div className="flex items-center gap-2">
        <div className="flex flex-wrap items-center cursor-pointer flex-1">
          ...
          />
          <p className="text-[13px] text-black ml-2">Ahmed Khan</p>
        </div>
        <p className="text-[13px] text-black">Nov 10, 2024</p>
      </div>
      <div className="my-6">
        ...
        The staff was very helpful in finding the right medication and explaining how to use it properly
        </p>
      </div>
    </div>
    ...
    <div className="w-full max-w-sm rounded p-4 bg-white shadow-[0_6px_24px_-12px_rgba(0,0,0,0.2)] border hover:shadow-lg transition-all duration-300 transform hover:scale-105">
      ...
      <div className="my-6">
        ...
        <p className="text-[13px] text-black mt-2">
        The level of care and attention at this hospital exceeded my expectations. I{"'"}m very grateful.
        </p>
      </div>
    </div>
      ...
      <div className="flex items-center gap-2">
        <div className="flex flex-wrap items-center cursor-pointer flex-1">
          <img
            ...
            className="w-7 h-7 rounded-full"
          />
          <p className="text-[13px] text-black ml-2">Khani</p>
        </div>
        <p className="text-[13px] text-black">Dec 5, 2024</p>
      </div>
      <div className="my-6">
        <div className="flex space-x-1">
          {[...Array(5)].map((_, i) => (
        ...
        <p className="text-[13px] text-black mt-2">
        I{"'"}ve been visiting this doctor for years, and the care is consistently top-notch.
        </p>
      </div>
    </div>
  </div>
